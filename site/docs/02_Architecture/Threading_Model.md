...
Related reading:
[Architecture](../02_Architecture/_index.md#cdv-state-machine) for state transitions,
[DirectShow Pipeline](DirectShow_Pipeline.md) for the pipeline each thread
operates on.
...
See [CapturingThread](#thread-lifecycle) for how the
