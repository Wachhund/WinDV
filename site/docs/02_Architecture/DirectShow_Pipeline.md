...
Related reading:
[Architecture](../02_Architecture/_index.md) for the class hierarchy,
[Threading Model](Threading_Model.md) for how frames are routed between threads.
...
See [Threading Model](Threading_Model.md) for queue details.
...
See [Threading Model](Threading_Model.md#post-capture-phase) for the
...
See [Threading Model](Threading_Model.md#monitoringthread-rate-limiter) for the full algorithm.
